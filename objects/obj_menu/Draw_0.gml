draw_sprite_stretched(spr_sbox, 0, x, y, widthFull, heightFull);
...
for (l = 0; l < (visibleOptionsMax + _desc); l++)
{
	...
	else
	{
		...
		if (_optionToShow < array_length(options))
		{
...
draw_sprite(spr_pointer, 0, x + xmargin - 20 , y + ymargin + ((hover - _scrollPush)* heightLine) - 12);
